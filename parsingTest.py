...
# breakpoint()
assert(parseBinaryTest("PHYS 2305 or PHYS 2205 and PHYS 2215") == (1,["PHYS2305",(0,["PHYS2205", "PHYS2215"])]))
...
assert(parseBinaryTest("BC 2024 and (PHYS 2305 or PHYS 2205 and PHYS 2215) or (CEM 2104 and PHYS 2305)") == (0, ["BC2024", (1, [(1,["PHYS2305", (0,["PHYS2205","PHYS2215"])]), (0,["CEM2104", "PHYS2305"])])]))
print(parseBinary("(BIOL 1005 and BIOL 1006) or (BIOL 1105 or (BIOL 1205H and BIOL 1206H)"))
assert(parseBinaryTest("(BIOL 1005 and BIOL 1006) or (BIOL 1105 or (BIOL 1205H and BIOL 1206H)") == (1, [(0, ["BIOL1005", "BIOL1006"]), (1,["BIOL1105", (0,["BIOL1205H", "BIOL1206H"])])]))
